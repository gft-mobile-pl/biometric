...
mavenPublishing {
    coordinates(project.property("libraryGroupId") as String, "biometric-api", project.property("libraryVersion") as String)

    pom {
        name.set(project.property("libraryNamePrefix") as String + " API")
